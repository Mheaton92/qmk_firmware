...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[LW] = LAYOUT_directional(
	    KC_LOCK, KC_F1, KC_F2,   KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8,  KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_NO, KC_NO,
	    KC_BTN1, KC_QUOT, KC_COMM,   KC_DOT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,  KC_NO,  KC_PSCR, KC_SLCK, KC_PAUS, KC_NO,
	    KC_LCTL, KC_A, KC_O,   KC_E, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,  KC_NO,  KC_NO,   KC_NO,   KC_NO,
	    KC_LSFT, NAS, CHMOD, KC_NO,   KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,  KC_NO,  KC_INS,  KC_HOME, KC_PGUP,
	    DF(4), MO(3), KC_TRNS, TT(0), KC_COPY, KC_PASTE, KC_CUT, KC_UNDO, KC_DEL, KC_END, KC_PGDN),
